...
const Contact = () => {
  ...
  return (
    <Box className='contact' id="contact" class="nav-link contact">
      ...
      <Text textAlign="center" color='white' m='0px' pb='5px'  id="contact-phone"> Contact :- +91 8617555571</Text>
      <Text textAlign="center" color='white' m='0px' pb='5px' id="contact-email"> Email :navneetburman900@gmail.com</Text>
