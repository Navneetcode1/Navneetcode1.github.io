            ...
            <Fade left>
              <Flex justifyContent={"space-around"}>
                ...
                <Button
                  ...
                  mt="30px"
                >
                  <Link href="https://www.linkedin.com/in/navneet-burman-b4b9181aa">
                    <Flex m="10px" alignItems={"center"}>
                      <Link
                        m="5px"
                        id="contact-linkedin"
                        href="https://www.linkedin.com/in/navneet-burman-b4b9181aa"
                        target="_blank"
                      >
                        <svg
                          fill={colorMode === "light" ? "black" : "white"}
              ...
              >
                <Image
                  ...
                  h="100px"
                  bg="white"
                  src="https://www.freepnglogos.com/uploads/letter-png/letter-beacon-hill-school-esf-year-update-beacon-3.png"
                ></Image>
                <Text fontSize={"22px"}>Drop a Message</Text>
                <svg
                  width="100px"
                  h="30px"
                  fill={colorMode === "light" ? "black" : "white"}
