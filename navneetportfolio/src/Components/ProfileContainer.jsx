...
const ProfileContainer = () => {
  ...
  return (
    <Box className='HeaderArea-dark' >
        ...
        <Box marginLeft='-8%'>
          <Image class="home-img" src='https://avatars.githubusercontent.com/u/110229662?v=4' zIndex="100%" blur="3xl" alt='Navneet Burman' className='photo_image' size={['sm', 'md', 'lg', '4xl']}/>
        </Box>
